...
function toggleLogout() {
    console.log("Icon clicked, toggleLogout function called");
    var dropdown = document.getElementById("logout-dropdown-content");
    dropdown.style.display = (dropdown.style.display === "block") ? "none" : "block";
    console.log("Dropdown is now " + dropdown.style.display);
}
