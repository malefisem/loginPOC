...
function toggleLogout(event) {
    ...
    console.log("Toggle logout function called"); // Add this log to check if the function is called
}

document.getElementById('logout-icon').addEventListener('click', function(event) {
    console.log("Logout icon clicked"); // Add this log to check if the logout icon is clicked
    toggleLogout(event);
});

// // Close the dropdown if the user clicks outside of it
// window.onclick = function(event) {
//     console.log("Window clicked"); // Add this log to check if the window click event is triggered
//     if (!event.target.matches('.logout-button')) {
//         console.log("Clicked element does not match logout button"); // Add this log to check if the clicked element doesn't match the logout button
//         var dropdowns = document.getElementsByClassName("logout-dropdown-content");
//         for (var i = 0; i < dropdowns.length; i++) {
//             var openDropdown = dropdowns[i];
//             if (openDropdown.classList.contains('show')) {
//                 openDropdown.classList.remove('show');
//                 console.log("Dropdown closed"); // Add this log to check if the dropdown is closed
//             }
//         }
//     }
// }
